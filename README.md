...
Стихи, тексты и другой авторский контент, опубликованный на сайте
(включая данные, хранящиеся в Firestore), являются © автора и **не**
подпадают под действие лицензии MIT — все права на контент защищены,
